...
``` 
0 0 * * * /opt/Ginzu-Valuation/Pipeline/run_rfr_update_sqlite.sh >> /var/log/Ginzu-Valuation/rfr_cron.log 2>&1
0 4 * * * /opt/Ginzu-Valuation/Pipeline/run_sec_update_pipeline.sh >> /var/log/Ginzu-Valuation/sec_cron.log 2>&1
```
