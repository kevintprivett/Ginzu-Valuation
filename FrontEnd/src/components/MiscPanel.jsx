        ...
        >
          ...
          <FormControl>
            <RadioGroup
              ...
              onChange={(event) => handleChange('hasOptions', event.target.value)}
              row
            >
              <FormControlLabel value={YesNo.YES} control={<Radio />} label={YesNo.YES} />
              <FormControlLabel value={YesNo.NO} control={<Radio />} label={YesNo.NO} />
            </RadioGroup>
          </FormControl>
        </Stack>
        ...
        >
          ...
          <FormControl>
            <RadioGroup
              ...
              onChange={(event) => handleChange('hasRdExpenses', event.target.value)}
              row
            >
              <FormControlLabel value={YesNo.YES} control={<Radio />} label={YesNo.YES} />
              <FormControlLabel value={YesNo.NO} control={<Radio />} label={YesNo.NO} />
