...
const CostOfCapitalPanel = () => {
  ...
  return (
    <>
      ...
      >
        ...
        >
          {Object.keys(CocApproaches).map((key) => {
            return (
              <MenuItem value={CocApproaches[key]}>
                {CocApproaches[key]}
              </MenuItem>
            );
          })}
      ...
      {company.cocApproach === CocApproaches.AVERAGE && (
        <CostOfCapitalAverage />
      )}
      {company.cocApproach === CocApproaches.DETAILED && (
        <CostOfCapitalDetailed />
      )}
    </>
  );
};
