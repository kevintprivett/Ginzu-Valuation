  ...
  return (
    <>
      <Stack direction="row" spacing={2} alignItems="center">
        <Typography variant="body1">Cost of Debt</Typography>
        <NumericFormat
      ...
      <Typography variant="body1" align="left" sx={{ minWidth: 500 }}>
        <em>
          Average Cost of Debt for {company.industry} is{' '}
          {marketData.industries[company.industry]['Cost of Debt']}%
        </em>
      </Typography>
    </>
  );
