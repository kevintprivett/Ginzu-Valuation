  ...
  return (
    <>
      ...
      >
        <NumericFormat
          value={
            override === null || override === true ? value : defaultLongValue
          }
          prefix={prefix}
          suffix={suffix}
          thousandSeparator
      ...
      >
        ...
        <ObjectRow
          ...
          handleValueChange={(property, value) =>
            handleObjectChange('revenueGrowth', value, property)
          }
          handleOverrideChange={(value) =>
            handleObjectChange('overrides', value, 'revenueGrowth')
          }
        ...
        <ObjectRow
          ...
          handleValueChange={(property, value) =>
            handleObjectChange('operatingMargin', value, property)
          }
        ...
        <ObjectRow
          ...
          handleValueChange={(property, value) =>
            handleObjectChange('salesCap', value, property)
          }
          handleOverrideChange={(value) =>
            handleObjectChange('overrides', value, 'salesCap')
          }
          handleClick={handleClick}
          prefix=""
          suffix=""
        ...
        <SimpleRow
          ...
          handleOverrideChange={(value) =>
            handleObjectChange('overrides', value, 'cocLong')
          }
          handleClick={handleClick}
          prefix=""
          suffix="%"
        ...
        <SimpleRow
          ...
          handleOverrideChange={(value) =>
            handleObjectChange('overrides', value, 'rocLong')
          }
          handleClick={handleClick}
          prefix=""
          suffix="%"
        ...
        <SimpleRow
          ...
          handleValueChange={(value) =>
            handleChange('taxRateEffectiveLong', value)
          }
          handleOverrideChange={(value) =>
            handleObjectChange('overrides', value, 'taxRateEffectiveLong')
          }
          handleClick={handleClick}
          prefix=""
          suffix="%"
        ...
        <SimpleRow
          ...
          handleOverrideChange={(value) =>
            handleObjectChange('overrides', value, 'rfrLong')
          }
          handleClick={handleClick}
          prefix=""
          suffix="%"
        ...
        <SimpleRow
          ...
          handleOverrideChange={(value) =>
            handleObjectChange('overrides', value, 'failureChance')
          }
          handleClick={handleClick}
          prefix=""
          suffix="%"
