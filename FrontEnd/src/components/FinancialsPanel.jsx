    ...
    >
      ...
      >
        ...
        <ObjectRow
          ...
          label='Revenues'
          onChange={(property, value) => handleObjectChange('revenues', value, property)} 
          prefix='$'
          suffix='MM'
        />
        <ObjectRow
          ...
          onChange={(property, value) => handleObjectChange('ebit', value, property)} 
          prefix='$'
          suffix='MM'
        />
        <ObjectRow
          ...
          onChange={(property, value) => handleObjectChange('interestExpense', value, property)} 
          prefix='$'
          suffix='MM'
        />
        <ObjectRow
          ...
          onChange={(property, value) => handleObjectChange('equity', value, property)}
          prefix='$'
          suffix='MM'
        />
        <ObjectRow
          ...
          onChange={(property, value) => handleObjectChange('debt', value, property)}
          prefix='$'
          suffix='MM'
        />
        <SimpleRow
        ...
        <ObjectRow
          ...
          onChange={(property, value) => handleObjectChange('cash', value, property)}
          prefix='$'
          suffix='MM'
        />
        <ObjectRow
