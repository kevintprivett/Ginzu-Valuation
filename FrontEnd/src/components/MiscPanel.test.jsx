...
describe('MiscPanel', async () => {
  ...
  test('component renders', () => {
    const element = screen.getByText('Are There R&D Expenses?');
  ...
  describe('Verify misc options selections', () => {
    test('Verify options option', async () => {
      ...
      const newComponent = screen.getByText('Average Maturity');
    ...
    test('Verify R&D option', async () => {
      ...
      const newComponent = screen.getByText('Current Year Expenses');
