...
describe('CostOfDebt', async () => {
  ...
  test('component renders', () => {
    const element = screen.getByText('Cost of Debt Approach');
  ...
  describe('Verify approach select box', () => {
    ...
    test('Verify synthetic', async () => {
      ...
      const select = screen.getByText(/Synthetic Credit Rating/);
    ...
    test('Verify actual', async () => {
      ...
      const select = screen.getAllByText(/Actual Credit Rating/)[1];
