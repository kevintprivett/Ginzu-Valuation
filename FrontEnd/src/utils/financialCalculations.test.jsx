...
describe('calculateCostOfCapital', () => {
  ...
  test('Average approach', () => {
    ...
    const firstEv = marketData.industries[Industries.ADVERTISING]['EV/Sales']
                    * 1000
    const firstCoc = marketData.industries[Industries.ADVERTISING]['Cost of Capital']
    const secondEv = marketData.industries[Industries.AEROSPACE_DEFENSE]['EV/Sales']
                    * 1000
    const secondCoc = marketData.industries[Industries.AEROSPACE_DEFENSE]['Cost of Capital']

    const expected = (firstEv * firstCoc + secondEv * secondCoc) 
                     / (firstEv + secondEv)
...
describe('calculateUnleveredBeta', () => {
  ...
  test('Multi approach', () => {
    ...
    const expected = (firstBusinessEv * firstBusinessBeta +
...
describe('calculateErp', () => {
  ...
  test('Countries approach', () => {
    ...
    const firstCountryErp = marketData.countries[Countries.UNITED_STATES]['ERP']
